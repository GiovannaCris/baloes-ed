...
/*
Uma lista é uma colecao ordenada de itens (ou seja, um elemento possui um 
antecessor e um sucessor)  em que seus elementos podem  ser acessados atra-
ves de sua posicao (tipo Posic). 
...
Tal valor invalido é denotado por NIL.
